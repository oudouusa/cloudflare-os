...
The non-duplicated post-index-fix **real-model** DeepSeek in-app normal response is
accepted. Not yet accepted: real-model-selected Gadget file/tool/test execution.
